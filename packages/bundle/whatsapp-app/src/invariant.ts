/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-whatsapp-app`.
 * @module @deepseek-ai/dsh-whatsapp-app/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@deepseek-ai/dsh-whatsapp-app'

/** Cordis companion plugin name. */
export const name = 'whatsapp-bundle-invariant'
