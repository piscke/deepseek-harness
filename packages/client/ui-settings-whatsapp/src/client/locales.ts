...
export const zh = {
  ...
  loggedOutReason: '原因',
  loggedOutBody: '当前凭据已失效，需要重新扫码配对。若提供方会自行清除它们，新的二维码将在此处显示。',
  chatsTitle: '会话',
...
export const en = {
  ...
  loggedOutBody: 'The current credentials are gone; the account has to pair again. If the provider clears them itself, a new code appears here.',
