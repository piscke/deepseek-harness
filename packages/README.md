...
| [`whatsapp/`](whatsapp/README.md) | WhatsApp capability family: seam, Baileys provider for one account, inbound routing into sessions, and the model-facing tools | POC |
