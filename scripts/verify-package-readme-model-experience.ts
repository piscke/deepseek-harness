...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-settings-whatsapp': { kind: 'none', reason: 'Browser-side pairing surface plus its loopback status channel; registers nothing model-facing.' },
  ...
  'packages/bundle/whatsapp-app': { kind: 'indirect', reason: 'The bundle is a patch-list carrier; the tool suite it inserts owns the four WhatsApp tools and their approval.' },
  ...
  'packages/whatsapp/whatsapp': { kind: 'indirect', reason: 'The seam registers no tool; a consumer that puts conversations in front of a model owns every rendered message.' },
  'packages/whatsapp/whatsapp-baileys': { kind: 'indirect', reason: 'The provider backend registers no tool; a consumer that puts conversations in front of a model owns every rendered message.' },
