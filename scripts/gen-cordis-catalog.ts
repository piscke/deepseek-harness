...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  configModulePath: 'not a service: boot-provided root accessor function (resolver for the root config directory | undefined) for Loader !!js config expressions — packages/boot/app-boot/README.md owns the boot contract',
