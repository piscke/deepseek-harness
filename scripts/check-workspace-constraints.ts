...
const packageFileExtras: Readonly<Record<string, readonly string[]>> = {
  ...
  // The provider entry and its invariant companion agree on status equality,
  // which tsdown shares through a hashed runtime chunk.
  '@deepseek-ai/dsh-whatsapp-baileys': ['lib/status-*.js'],
}
