...
| `ctx.whatsapp` | `seam` | [`whatsapp`](../packages/whatsapp/whatsapp) | [`whatsapp-baileys`](../packages/whatsapp/whatsapp-baileys) | - | - | 一次注册拥有一个已认证账号，因此该槽位只容纳单个 provider，状态也是能力的一部分；暂无面向模型的消费方随附。 |
