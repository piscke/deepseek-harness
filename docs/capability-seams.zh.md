...
flowchart LR
  ...
  svc_whatsapp["ctx.whatsapp<br/>WhatsApp account seam"]
  ...
  pkg_whatsapp --> svc_whatsapp
  pkg_whatsapp_baileys --> svc_whatsapp
  ...
  svc_whatsapp --> pkg_tool_whatsapp
  svc_whatsapp --> pkg_whatsapp_workspace
...
| `ctx.whatsapp` | `seam` | [`whatsapp`](../packages/whatsapp/whatsapp) | [`whatsapp-baileys`](../packages/whatsapp/whatsapp-baileys) | [`tool-whatsapp`](../packages/whatsapp/tool-whatsapp), [`whatsapp-workspace`](../packages/whatsapp/whatsapp-workspace) | - | 一次注册拥有一个已认证账号，因此该槽位只容纳单个 provider，状态也是能力的一部分；tool-whatsapp 拥有面向模型的名称，whatsapp-workspace 将入站消息流路由进会话。 |
