...
Source: [`packages/whatsapp/tool-whatsapp/src/index.ts:39`](../packages/whatsapp/tool-whatsapp/src/index.ts)
...
Source: [`packages/whatsapp/whatsapp-baileys/src/index.ts:48`](../packages/whatsapp/whatsapp-baileys/src/index.ts)

<a id="deepseek-aidsh-whatsapp-workspace"></a>

## `@deepseek-ai/dsh-whatsapp-workspace`

Requires: `agentDefaultModel` · `agents` · `sessionPersistence` · `sessions` · `sessionTitle` · `whatsapp` · `workspaceRegistry`
...
Source: [`packages/whatsapp/whatsapp-workspace/src/index.ts:72`](../packages/whatsapp/whatsapp-workspace/src/index.ts)
...
- `@deepseek-ai/dsh-client-ui-settings-whatsapp` — requires `connection` · `whatsapp` ([`packages/client/ui-settings-whatsapp/src/index.ts`](../packages/client/ui-settings-whatsapp/src/index.ts))
