...
| `ctx.whatsapp` | `seam` | [`whatsapp`](../packages/whatsapp/whatsapp) | [`whatsapp-baileys`](../packages/whatsapp/whatsapp-baileys) | [`tool-whatsapp`](../packages/whatsapp/tool-whatsapp), [`whatsapp-workspace`](../packages/whatsapp/whatsapp-workspace) | - | One registration owns one authenticated account, so the slot holds a single provider and status is part of the capability; tool-whatsapp owns the model-facing names and whatsapp-workspace routes the inbound stream into sessions. |
