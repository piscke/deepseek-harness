...
- `@deepseek-ai/dsh-client-ui-settings-whatsapp` — 需要 `connection` · `whatsapp`（[`packages/client/ui-settings-whatsapp/src/index.ts`](../packages/client/ui-settings-whatsapp/src/index.ts)）
...
- `@deepseek-ai/dsh-whatsapp-app`（[`packages/bundle/whatsapp-app/src/index.ts`](../packages/bundle/whatsapp-app/src/index.ts)）
